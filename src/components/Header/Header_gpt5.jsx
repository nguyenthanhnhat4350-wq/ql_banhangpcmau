  ...
  return (
    <footer className="phone-footer">
      ...
      <div className="footer-content">
        ...
        <div className="footer-left">
          {/* <div className="footer-logo">
            <img src={logo} alt="phone" className="footer-logo-img" />
          </div> */}
          <p className="footer-copyright">©2025 phone. All rights reserved</p>
        </div>
        ...
        <div className="footer-middle">
          ...
          <div className="footer-column">
            <h3 className="footer-column-title">VỀ phone</h3>
      ...
      <div className="footer-bottom-legal">
        <p>
          © 2026. Công Ty Cổ Phần Đầu Tư Thương Mại phone. GPĐKKD: 0303217354 do sở KH & ĐT TP.HCM cấp ngày 02/01/2007. GPMXH: 21/GP-BTTTT do Bộ Thông Tin và Truyền Thông cấp ngày 11/01/2026.
        </p>
        <p>
          Địa chỉ: ... . Điện thoại: 028 38125960. Email: hotrotmdt@phone.com.
        </p>
        <p>
